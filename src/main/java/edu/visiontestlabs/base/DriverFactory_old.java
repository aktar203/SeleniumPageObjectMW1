...
public class DriverFactory_old {
    ...
    private DriverFactory_old(){
        //Do-nothing..Do not allow to initialize this class from outside
    }
    
    private static DriverFactory_old instance = new DriverFactory_old();

    public static DriverFactory_old getInstance()
    {
        return instance;
    }
    		...
    		ThreadLocal<WebDriver> driver = new ThreadLocal<WebDriver>()
    {
        ...
        protected WebDriver initialValue()
        {
            ...
            if(driverName.toUpperCase().contentEquals("CHROME")){
                ...
                chromeBinayPath =  System.getProperty("user.dir") + "/src/main/resources/driver/32/chromedriver";
